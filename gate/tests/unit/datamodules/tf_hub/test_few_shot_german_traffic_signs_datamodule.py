...
def test_aircraft_fewshot_datamodules(
    ...
    dataset_config = GermanTrafficSignsFewShotDatasetConfig(
        dataset_root=".test/datasets/german_traffic_signs",
        split_name="train",
        download=True,
        num_episodes=100,
    ...
    transform_train = FewShotTransformConfig(
        support_set_input_transform=german_traffic_signs_support_set_transforms(),
        query_set_input_transform=german_traffic_signs_query_set_transforms(),
