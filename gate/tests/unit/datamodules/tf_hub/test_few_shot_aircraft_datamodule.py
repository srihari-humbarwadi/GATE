...
from gate.configs.datamodule.few_shot_classification import (
    AircraftFewShotDatasetConfig, FewShotDataModuleConfig, FewShotTransformConfig)
from gate.configs.datasets.transforms import (aircraft_query_set_transforms,
...
def test_aircraft_fewshot_datamodules(
    ...
    dataset_config = AircraftFewShotDatasetConfig(
        dataset_root=".test/datasets/aircraft",
        split_name="train",
        download=True,
        num_episodes=100,
    ...
    transform_train = FewShotTransformConfig(
        support_set_input_transform=aircraft_support_set_transforms(),
        query_set_input_transform=aircraft_query_set_transforms(),
