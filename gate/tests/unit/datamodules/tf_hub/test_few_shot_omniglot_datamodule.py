...
from gate.configs.datamodule.few_shot_classification import (
    FewShotDataModuleConfig, FewShotTransformConfig, OmniglotFewShotDatasetConfig)
from gate.configs.datasets.transforms import (omniglot_query_set_transforms,
...
def test_omniglot_fewshot_datamodules(
    ...
    dataset_config = OmniglotFewShotDatasetConfig(
        dataset_root=".test/datasets/omniglot",
        split_name="train",
        download=True,
        num_episodes=100,
    ...
    transform_train = FewShotTransformConfig(
        support_set_input_transform=omniglot_support_set_transforms(),
        query_set_input_transform=omniglot_query_set_transforms(),
