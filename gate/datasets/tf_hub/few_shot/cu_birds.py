...
class CUB200FewShotClassificationDataset(FewShotClassificationDatasetTFDS):
    def __init__(
        self,
        dataset_root: Union[str, pathlib.Path],
        split_name: str,
        ...
        super(CUB200FewShotClassificationDataset, self).__init__(
            ...
            split_percentage={
                FewShotSuperSplitSetOptions.TRAIN: 120,
                FewShotSuperSplitSetOptions.VAL: 40,
                FewShotSuperSplitSetOptions.TEST: 40,
            },
...
class CUB200MultiViewFewShotClassificationDataset(
    MultiViewFewShotClassificationDatasetTFDS
):
    def __init__(
        self,
        ...
        DATASET_NAME = "caltech_birds2011"
        super(CUB200MultiViewFewShotClassificationDataset, self).__init__(
            modality_config=DottedDict(image=True),
            input_shape_dict=DottedDict(image=dict(channels=3, height=84, width=84)),
            dataset_name=DATASET_NAME,
            dataset_root=dataset_root,
